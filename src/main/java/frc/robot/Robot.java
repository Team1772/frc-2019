...
public class Robot extends TimedRobot {
	...
	public void robotInit() {
		...
		_talon.configPeakOutputForward(0.4, Constants.kTimeoutMs);
		_talon.configPeakOutputReverse(-0.4, Constants.kTimeoutMs);
	...
	void commonLoop() {
		 ...
		 */
		if (!_lastButton1 && button1 && !maxPos) {
			/* Position Closed Loop */

			/* 10 Rotations * 4096 u/rev in either direction */
			//targetPositionRotations = leftYstick * 10 * 4096;
			_talon.set(ControlMode.Position, -40000);
		}
